...
using TransactionEmpty.Ayudas;
using TransactionEmpty.ServicioTransactionEmpty;

namespace TransactionEmpty
{
    public partial class App : Application
    {
        private void ApplicationStartup(object sender, StartupEventArgs e)
        {
            var actualizadorAutomatico = new ActualizadorAutomatico("TRANSACTION EMPTY", ResourceAssembly.Location, "TransactionEmpty", "RTM");
        ...
        {
            using (var servicio = new ServicioTransactionEmptyClient())
            {
        ...
        private void AnunciarProblema(string mensaje)
        {
            using (var servicio = new ServicioAnuncianteProblema.ServicioAnuncianteProblemaClient())
            {
                servicio.AnunciarProblemaServicioWebTransaction(mensaje, ((KIOSK)App.Current.Resources["Quiosco"]).ZONE_ID, 4);
            }
        }
