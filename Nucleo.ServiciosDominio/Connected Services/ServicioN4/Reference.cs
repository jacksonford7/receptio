...
namespace RECEPTIO.CapaDominio.Nucleo.ServiciosDominio.ServicioN4
{
    // 
    ...
    public partial class ArgoService : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        public ArgoService()
        {
            this.Url = ConfigurationManager.AppSettings["UrlServicioN4"].ToString();
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BegingenericInvoke(genericInvoke genericInvoke1, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("genericInvoke", new object[] {
                    genericInvoke1}, callback, asyncState);
        }

        /// <remarks/>
        public genericInvokeResponse EndgenericInvoke(System.IAsyncResult asyncResult)
        {
